...
class AdipoModel:
    ...
    @staticmethod
    def get_training_input_from_df(df: pd.DataFrame) -> tuple[torch.Tensor, StandardScaler]:
        """
    ...
    @staticmethod
    def get_prediction_input_from_df(df: pd.DataFrame, scaler: StandardScaler) -> torch.Tensor:
        """
    ...
    @classmethod
    def train_model(cls, full_df: pd.DataFrame, n_epochs: int = 1000, seed: int = 42, val_frac: float = 0.2, test_frac: float = 0.2) -> tuple[AdipoNN, list, list, list, StandardScaler]:
        """
    ...
    @classmethod
    def evaluate_model(cls, model: AdipoNN, scaler: StandardScaler, full_df: pd.DataFrame, test_ids: list) -> None:
        """
    ...
    @staticmethod
    def save_model(filename: str, model: AdipoNN, train_ids: list, val_ids: list, test_ids: list) -> None:
        """
    ...
    @classmethod
    def predict_and_clean_image(cls, model: AdipoNN, scaler: StandardScaler, samp_id: str, full_df: pd.DataFrame, unfiltered_seg: np.ndarray) -> np.ndarray:
        """
